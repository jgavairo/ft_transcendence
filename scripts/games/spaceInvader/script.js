...
export function game() {
    ...
    canvas.height = ch;
    //Game
    var bullets = [], asteroids = [], explosions = [], destroyed = 0, record = 0, count = 0, playing = false, gameOver = false, _planet = { deg: 0 };
    //Player
    var player = {
        posX: -35,
        posY: -(100 + 82),
    ...
    function newAsteroid() {
        var type = random(1, 4), coordsX, coordsY;
        switch (type) {
            case 1:
                coordsX = random(0, cw);
                coordsY = 0 - 150;
        ...
        var asteroid = {
            ...
            coordsY: coordsY || 0,
            size: random(1, 3),
            deg: Math.atan2((coordsX || 0) - (cw / 2), -((coordsY || 0) - (ch / 2))),
            destroyed: false
        };
